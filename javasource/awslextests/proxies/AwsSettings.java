...
public class AwsSettings
{
	 ...
	 */
	public static final java.lang.String entityName = "AwsLexTests.AwsSettings";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "AwsLexTests.AwsSettings"));
	}
	...
	protected AwsSettings(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject awsSettingsMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("AwsLexTests.AwsSettings", awsSettingsMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a AwsLexTests.AwsSettings");
	 ...
	 */
	@Deprecated
	public static awslextests.proxies.AwsSettings initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return awslextests.proxies.AwsSettings.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static awslextests.proxies.AwsSettings initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new awslextests.proxies.AwsSettings(context, mendixObject);
	}

	public static awslextests.proxies.AwsSettings load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return awslextests.proxies.AwsSettings.initialize(context, mendixObject);
	}

	public static java.util.List<awslextests.proxies.AwsSettings> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<awslextests.proxies.AwsSettings> result = new java.util.ArrayList<awslextests.proxies.AwsSettings>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//AwsLexTests.AwsSettings" + xpathConstraint))
			result.add(awslextests.proxies.AwsSettings.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final awslextests.proxies.AwsSettings that = (awslextests.proxies.AwsSettings) obj;
	...
	{
		return "AwsLexTests.AwsSettings";
	}
